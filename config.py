...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "25245282"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","22ab0e1f738fbd464b5c2a05f7dff44f")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8343503290:AAF0whYPdXvOkgiv4V02eZ3nDAgXk9-tyak")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@bidibhai_bot")
BOT_TEXT = "bidi bhai ka bot"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "8343503290"))
# ------------------------------------------------
# //LOG CHANNEL ID 
